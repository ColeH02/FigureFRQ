...
public class Main {
    ...
    public static void main(String[] args) {
        Figure datarow0 = new Figure(1, 3, 20, 7);
        Figure datarow1 = new Figure(2, 3, 20, 8);
        Figure datarow2 = new Figure(3, 3, 22, 9);
        Figure datarow3 = new Figure(4, 3, 24, 10);
        Figure datarow4 = new Figure(5, 3, 26, 12);
